...
var svgs=Array.prototype.slice.call(el.querySelectorAll("svg,path,polyline,polygon,line"));
for(var i=0;i<svgs.length;i+=1){
var node=svgs[i];
if(node&&node.style){
node.style.fill=contrast;
node.style.stroke=contrast;
