...
async function resolveRuntimeScope(input: { clientId: string; siteId: string; agencyId: string; siteVersionId: string }): Promise<{ runtimeSiteId: string; siteVersionId: string } | null> {
