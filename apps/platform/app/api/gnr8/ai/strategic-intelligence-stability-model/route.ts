...
import { buildStrategicIntelligenceStabilityModelV1 } from "@/gnr8/ai/strategic-intelligence-stability-model";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const strategicIntelligenceStabilityModel: StrategicIntelligenceStabilityModelV1 = buildStrategicIntelligenceStabilityModelV1({
    ...
    return NextResponse.json({ strategicIntelligenceStabilityModel }, { status: 200 });
  } catch (error) {
