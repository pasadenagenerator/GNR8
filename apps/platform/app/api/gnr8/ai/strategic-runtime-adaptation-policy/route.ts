...
export async function POST(req: NextRequest) {
  try {
    ...
    const strategicRuntimeAdaptationPolicy: StrategicRuntimeAdaptationPolicyV1 = buildStrategicRuntimeAdaptationPolicyV1({
    ...
    return NextResponse.json({ strategicRuntimeAdaptationPolicy }, { status: 200 });
  } catch (error) {
