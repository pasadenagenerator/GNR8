...
export async function POST(req: NextRequest) {
  try {
    ...
    const strategicSemanticExecutionReadinessCandidate = normalizeOptionalRecord(body, ["strategicSemanticExecutionReadiness", "strategicSemanticReadiness"]);
    ...
    const strategicLearningCore = buildStrategicLearningCoreV1({
      executionLearningSignals,
