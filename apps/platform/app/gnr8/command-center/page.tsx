    ...
    <>
      ...
      <section style={{ marginTop: 12, border: "1px solid #dbe6f1", borderRadius: 12, background: "#fff", padding: 14 }}>
        ...
        <div style={{ display: "grid", gap: 10, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
          ...
          <article style={{ border: "1px solid #dbe6f1", borderRadius: 10, padding: 12 }}>
            <h3 style={{ marginTop: 0, marginBottom: 8, fontSize: 16 }}>AI Settings</h3>
            <p style={{ margin: 0, fontSize: 13, color: "#475569" }}>
              Agency-level AI provider status and Airship agent profile defaults.
            </p>
            <Link href="/gnr8/command-center/ai-settings" style={{ display: "inline-flex", marginTop: 10, fontSize: 13 }}>
              Open AI Settings
            </Link>
          </article>
