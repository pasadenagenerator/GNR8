    ...
    >
      ...
      <>
        ...
        <section style={{ marginTop: 16, border: "1px solid #dbe6f1", borderRadius: 12, background: "#fff", padding: 16 }}>
            ...
            {readModel.client_directory.length === 0 ? (
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  ...
                  <tbody>
                    {readModel.client_directory.map((client) => (
                        ...
                        <td style={{ padding: "8px 10px" }}>
                          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                            ...
                            {canEditClientSettings ? (
                              <Link
                                href={`/gnr8/agency/clients/${encodeURIComponent(client.id)}/settings?agency=${encodeURIComponent(currentUserAgency.agency_id)}`}
                                style={actionLinkStyle()}
                              >
                                Client Settings
                              </Link>
                            ...
                            {canViewClientUsers ? (
                              <Link
                                href={`/gnr8/agency/clients/${encodeURIComponent(client.id)}/users?agency=${encodeURIComponent(currentUserAgency.agency_id)}`}
                                style={actionLinkStyle()}
                              >
                                Client Team
                              </Link>
