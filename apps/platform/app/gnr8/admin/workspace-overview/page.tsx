...
export default async function WorkspaceOverviewPage() {
  ...
  return (
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "24px 20px", fontFamily: "ui-sans-serif, system-ui" }}>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Bundle Preview</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionBundlePreviews.map((bundlePreview) => (
            <article key={bundlePreview.bundleId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{bundlePreview.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>bundleState: {bundlePreview.bundleState}</p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>readinessState: {bundlePreview.readinessState}</p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>readinessScore: {bundlePreview.readinessScore}</p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Included Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {bundlePreview.includedComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Missing Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {bundlePreview.missingComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(bundlePreview.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(bundlePreview.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(bundlePreview.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                providerExecutionAllowed: {String(bundlePreview.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>governanceState: {bundlePreview.governanceState}</p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{bundlePreview.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Authorization Package</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionAuthorizationPackageRecords.map((authorizationPackage) => (
            <article key={authorizationPackage.proposalId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{authorizationPackage.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                packageState: {authorizationPackage.packageState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {authorizationPackage.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessScore: {authorizationPackage.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                authorizationType: {authorizationPackage.authorizationType}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Included Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationPackage.includedComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Missing Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationPackage.missingComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(authorizationPackage.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(authorizationPackage.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(authorizationPackage.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                providerExecutionAllowed: {String(authorizationPackage.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>governanceState: {authorizationPackage.governanceState}</p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{authorizationPackage.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Intent</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionIntentRecords.map((intentRecord) => (
            <article key={intentRecord.proposalId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{intentRecord.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                intentState: {intentRecord.intentState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {intentRecord.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessScore: {intentRecord.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                intentType: {intentRecord.intentType}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Intended Actions</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {intentRecord.intendedActions.map((intendedAction) => (
                  <li key={intendedAction}>{intendedAction}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {intentRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(intentRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(intentRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(intentRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                providerExecutionAllowed: {String(intentRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>governanceState: {intentRecord.governanceState}</p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{intentRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Intent Readiness</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionIntentReadinessRecords.map((intentReadinessRecord) => (
            <article key={intentReadinessRecord.proposalId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{intentReadinessRecord.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {intentReadinessRecord.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                readinessScore: {intentReadinessRecord.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Requirements Met</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {intentReadinessRecord.requirementsMet.map((requirement) => (
                  <li key={requirement}>{requirement}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Requirements Missing</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {intentReadinessRecord.requirementsMissing.map((requirement) => (
                  <li key={requirement}>{requirement}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(intentReadinessRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(intentReadinessRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(intentReadinessRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                providerExecutionAllowed: {String(intentReadinessRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {intentReadinessRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{intentReadinessRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Candidate Readiness</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionCandidateReadinessRecords.map((readinessRecord) => (
            <article key={readinessRecord.candidateId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{readinessRecord.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
              ...
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                candidatePresent: {String(readinessRecord.candidatePresent)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                candidateArtifactsPresent: {String(readinessRecord.candidateArtifactsPresent)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Requirements Met</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {readinessRecord.requirementsMet.map((requirement) => (
              ...
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {readinessRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              ...
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {readinessRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{readinessRecord.summary}</p>
            </article>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Candidate Package</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionCandidatePackageRecords.map((packageRecord) => (
            <article key={packageRecord.candidateId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{packageRecord.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                packageState: {packageRecord.packageState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {packageRecord.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessScore: {packageRecord.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                candidateType: {packageRecord.candidateType}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Included Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {packageRecord.includedComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Missing Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {packageRecord.missingComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {packageRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(packageRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(packageRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(packageRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                providerExecutionAllowed: {String(packageRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {packageRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{packageRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Candidate Authorization</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionCandidateAuthorizationRecords.map((authorizationRecord) => (
            <article key={authorizationRecord.proposalId} style={CARD_STYLE}>
              <h3 style={{ marginTop: 0, marginBottom: 6 }}>{authorizationRecord.proposalTitle}</h3>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                authorizationState: {authorizationRecord.authorizationState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {authorizationRecord.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessScore: {authorizationRecord.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
              ...
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Required Authorizations</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationRecord.requiredAuthorizations.map((requiredAuthorization) => (
                  <li key={requiredAuthorization}>{requiredAuthorization}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {authorizationRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Permissions</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(authorizationRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(authorizationRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(authorizationRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                providerExecutionAllowed: {String(authorizationRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{authorizationRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Candidate Authorization Readiness</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionCandidateAuthorizationReadinessRecords.map((authorizationReadinessRecord) => (
            <article key={authorizationReadinessRecord.proposalId} style={CARD_STYLE}>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                proposalId: {authorizationReadinessRecord.proposalId}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessState: {authorizationReadinessRecord.readinessState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                readinessScore: {authorizationReadinessRecord.readinessScore}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                authorizationPresent: {String(authorizationReadinessRecord.authorizationPresent)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                authorizationRequirementsPresent: {String(authorizationReadinessRecord.authorizationRequirementsPresent)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Requirements Met</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationReadinessRecord.requirementsMet.map((requirement) => (
                  <li key={requirement}>{requirement}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Requirements Missing</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationReadinessRecord.requirementsMissing.map((requirement) => (
                  <li key={requirement}>{requirement}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationReadinessRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {authorizationReadinessRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Permissions</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(authorizationReadinessRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(authorizationReadinessRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(authorizationReadinessRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                providerExecutionAllowed: {String(authorizationReadinessRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{authorizationReadinessRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section style={{ marginTop: 16 }}>
        <h2 style={{ marginBottom: 10 }}>Execution Candidate Authorization Package</h2>
        <div style={{ display: "grid", gap: 10 }}>
          {model.executionCandidateAuthorizationPackageRecords.map((authorizationPackageRecord) => (
            <article key={authorizationPackageRecord.proposalId} style={CARD_STYLE}>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                proposalId: {authorizationPackageRecord.proposalId}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                packageState: {authorizationPackageRecord.packageState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
              ...
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                authorizationType: {authorizationPackageRecord.authorizationType}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Included Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationPackageRecord.includedComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Missing Components</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationPackageRecord.missingComponents.map((component) => (
                  <li key={component}>{component}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Blocked Reasons</strong></p>
              <ul style={{ marginTop: 0, marginBottom: 8 }}>
                {authorizationPackageRecord.blockedReasons.map((blockedReason) => (
                  <li key={blockedReason}>{blockedReason}</li>
                ))}
              </ul>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Governance</strong></p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                governanceState: {authorizationPackageRecord.governanceState}
              </p>
              <p style={{ marginTop: 0, marginBottom: 6 }}><strong>Permissions</strong></p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                executionAllowed: {String(authorizationPackageRecord.executionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                mutationAllowed: {String(authorizationPackageRecord.mutationAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}>
                publishingAllowed: {String(authorizationPackageRecord.publishingAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 8 }}>
                providerExecutionAllowed: {String(authorizationPackageRecord.providerExecutionAllowed)}
              </p>
              <p style={{ marginTop: 0, marginBottom: 4 }}><strong>Summary</strong></p>
              <p style={{ margin: 0 }}>{authorizationPackageRecord.summary}</p>
            </article>
          ))}
        </div>
      </section>
