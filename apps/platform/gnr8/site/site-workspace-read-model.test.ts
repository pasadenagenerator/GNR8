    ...
    multipageImport: {
      summary: {
        ...
        templateFamilyExtraction: {
          enabled: true,
          familyCount: 4,
          assignedRouteCount: 14,
          singletonFamilyCount: 1,
          mixedFamilyCount: 0,
          listingDetailRelationshipCount: 1,
          highConfidenceFamilyCount: 2,
          diagnostics: ['TEMPLATE_FAMILY_EXTRACTION_COMPLETED:4'],
        },
        canonicalDiscovery: {
          canonicalEntries: [],
...
test('preview runtime summary parser accepts raw template preview mode', () => {
  const parsed = __siteWorkspaceReadModelTestUtils.parsePreviewRuntimeSummary({
    ...
    rawTemplatePreviewEvidence: {
      ...
      dbClientReusePath: 'renderer_request_scoped_client',
      ...
      rawPreviewAssetRewriteEvidence: {
        ...
        cssUrlReferencesRewritten: 1,
        cssUrlReferencesExternalPreserved: 1,
        cssUrlReferencesMissing: 1,
        imageReferencesFound: 2,
        imageReferencesRewritten: 1,
        imageReferencesMissing: 1,
        fontStylesheetsFound: 1,
        fontStylesheetsPreserved: 1,
        fontFilesFound: 1,
        fontFilesRewritten: 1,
        fontFamilyDongleDetected: true,
        rootHeadingDongleEvidence: ['CSS declares Dongle font family'],
        malformedUriDecodeFallbackCount: 1,
        assetReferencesInspected: 4,
        assetReferencesRewritten: 2,
        assetReferencesMissing: 1,
        assetReferencesExternalPreserved: 1,
        assetReferenceEvidence: [
          {
            originalReference: '/missing/hero.jpg',
            normalizedReference: '/missing/hero.jpg',
            resolvedCandidate: 'missing/hero.jpg',
      ...
      rawPreviewAssetGraphEvidence: {
        routePath: '/',
        rawFilePath: 'pages/root/index.html',
        cssCascadeOrderBefore: [
          {
            index: 0,
            tagName: 'link',
            reference: 'assets/site.css',
            rel: 'stylesheet',
            as: null,
            media: null,
            type: null,
            sourceType: 'link_stylesheet',
          },
        ],
        cssCascadeOrderAfter: [
          {
            index: 0,
            tagName: 'link',
            reference: '/api/gnr8/runtime/preview-assets/site/sv/assets/site.css',
            rel: 'stylesheet',
            as: null,
            media: null,
            type: null,
        ...
        stylesheetRefsFound: [
          {
            originalReference: 'assets/site.css',
            matchedFilePath: 'assets/site.css',
            servedPreviewUrl: '/api/gnr8/runtime/preview-assets/site/sv/assets/site.css',
            reason: 'matched_persisted_file',
            sourceType: 'html_attr',
          },
        ],
        ...
        dongleEvidence: {
          detected: true,
          source: 'CSS declares Dongle font family',
          ref: 'https://fonts.googleapis.com/css2?family=Dongle',
        },
        primaryCssCandidates: ['assets/site.css'],
        topMissingStylesheetRefs: [],
        topMissingImageRefs: ['/missing/hero.jpg'],
        stylesheetRefsFoundCount: 1,
        stylesheetRefsRewrittenCount: 1,
        stylesheetRefsPreservedExternalCount: 0,
        stylesheetRefsMissingCount: 0,
        inlineStyleBlockCount: 0,
        mediaStylesheetCount: 0,
        preloadStyleCount: 0,
        missingStylesheetRefs: [],
        cssOrderChanged: false,
      },
      rawPreviewScriptPolicyEvidence: {
        totalScriptsFound: 5,
        scriptsPreserved: 3,
        scriptsBlocked: 2,
        scriptsRewrittenToControlledPreviewAssetUrls: 2,
        scriptsExternalPreserved: 1,
        scriptsBlockedByReason: {
          duplicate_dom_injection_blocked: 1,
          tracking_or_analytics_script_blocked: 1,
        },
        topBlockedRefs: ['inline:1:document.body.innerHTML'],
        galleryCandidateScriptsDetected: true,
        mapCandidateScriptsDetected: true,
        formCandidateScriptsDetected: true,
        lazyloadCandidateScriptsDetected: true,
      },
      rawPreviewDuplicateGuardEvidence: {
        ...
        guardReason: ['non_root_route', 'root_block_before_listing_container'],
      ...
      rawPreviewEmbedEvidence: {
        ...
        blockedMapRefs: [],
        externalMapProviders: ['google_maps', 'leaflet'],
      },
      runtimeDuplicateGuardInjected: true,
      runtimeDuplicateGuardMode: 'mutation_observer_root_home_duplicate_guard',
      runtimeDuplicateGuardFingerprintCount: 3,
