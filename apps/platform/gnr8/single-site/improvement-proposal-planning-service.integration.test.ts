  ...
  try {
    ...
    const authorization = await proposals.attachImplementationAuthorizationRef({
      ...
      authorizationValidation: {
        ...
        subjectId: plan.plan.id,
        approvalRequestId: "implementation-authorization-request-1",
        approvalDecisionId: "implementation-authorization-decision-1",
        evidencePackageId: "implementation-authorization-evidence-1",
        limitations: [],
        blockerCodes: [],
        semanticWatermark: "implementation-authorization:integration-placeholder",
      },
      actor: actor(),
