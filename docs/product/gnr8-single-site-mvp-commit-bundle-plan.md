...
| 7 | `20260730170000_aaf_single_site_implementation_authorization_scope.sql` | Extends AAF scopes for implementation authorization | Yes | AAF/single-site | Check AAF scope definition accepts `single_site_implementation_authorization`. |
