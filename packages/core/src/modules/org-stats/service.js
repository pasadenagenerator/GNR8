...
export class OrgStatsService {
    ...
    entitlementService;
    constructor(orgStatsRepository, authorizationService, entitlementService) {
        this.orgStatsRepository = orgStatsRepository;
        this.authorizationService = authorizationService;
        this.entitlementService = entitlementService;
    }
    async getOrgStats(input) {
        ...
        const role = await this.orgStatsRepository.getActorRoleInOrg({
            actorUserId,
            orgId,
        });
        if (!role) {
        ...
        const hasBilling = Boolean(row.sub_plan_key) ||
